#
# The SincNet model is borrowed from https://github.com/mravanelli/SincNet
#
...
class SincConv(nn.Module):
    ...
    def forward(self, waveforms):
        ...
        band_pass_left = ((torch.sin(f_times_t_high) - torch.sin(f_times_t_low)) / (
                    ...
                    # Just expanded the sinc and simplified the terms. This way I avoid several useless computations.
...
class SincNet(nn.Module):
    ...
    def __init__(self, options):
        ...
        for i in range(self.N_cnn_lay):
            ...
            if i == 0:
                self.conv.append(SincConv(self.cnn_N_filt[0], self.cnn_len_filt[0], self.fs))
